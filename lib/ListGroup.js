...
var _disallowedProps = require('./disallowedProps');

var _disallowedProps2 = _interopRequireDefault(_disallowedProps);
...
var ListGroup = (function (_React$Component) {
  ...
  ListGroup.prototype.renderUL = function renderUL(items) {
    ...
    var allowedProps = _lodash.omit(this.props, _disallowedProps2['default']['ul']);
  ...
  ListGroup.prototype.renderDiv = function renderDiv(items) {
    var allowedProps = _lodash.omit(this.props, _disallowedProps2['default']['div']);
    return _react2['default'].createElement(
      'div',
      _extends({}, allowedProps, {
        className: _classnames2['default'](this.props.className, 'list-group') }),
